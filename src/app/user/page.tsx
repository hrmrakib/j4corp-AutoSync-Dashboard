...
export default function UserListPage() {
  ...
  return (
    <div className='min-h-screen bg-white px-10 py-4'>
        ...
        <div className='overflow-hidden'>
          ...
          <div className='hidden md:block'>
            <table className='w-full'>
              <thead className='bg-table-header-bg border-b border-[#1D4ED8]'>
                <tr>
                  ...
                  <tr key={user.id} className='hover:bg-gray-50'>
                    ...
                    <td className='px-6 py-4'>
                      ...
                      <Button
                        ...
                        onClick={() => handleActionClick(user)}
                      >
                        <MessageCircleMore className='h-4 w-4 text-gray-700' />
                      </Button>
                    </td>
                  </tr>
                ))}
              ...
              <div className='space-y-4 bg-[#E5E7EB] rounded-xl p-4'>
                ...
                <div className='space-y-4'>
                  <p className='text-base text-[#1F2937]'>
                    Make:{" "}
                    <span className='font-semibold text-[#030712]'>BMW</span>
                  </p>
                  <p className='text-base text-[#1F2937]'>
                    Model:{" "}
                    <span className='font-semibold text-[#030712]'>G0310R</span>
                  </p>
                  <p className='text-base text-[#1F2937]'>
                    Year:{" "}
                    <span className='font-semibold text-[#030712]'>2025</span>
                  </p>
                  <p className='text-base text-[#1F2937]'>
                    VIN:{" "}
